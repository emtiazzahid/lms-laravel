              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                 ...
                 <li>
                      ...
                      <li class="<?php echo e(Route::currentRouteName()=='getTeacherStudentsListPage' ? 'active' : ''); ?>"><a href="<?php echo e(Route('getTeacherStudentsListPage')); ?>"><i class="fa fa-building-o"></i> My Students </a></li>
                        <?php endif; ?>
                 ...
                 <li>
                      ...
                      <ul class="nav child_menu">
                      <li class="<?php echo e(Route::currentRouteName()=='departments-list' ? 'active' : ''); ?>"><a href="<?php echo e(Route('departments-list')); ?>"><i class="fa fa-list-alt" aria-hidden="true"></i> Departments </a></li>
                      </ul>
                 </li>
                    <?php endif; ?>
                 <li>
                      ...
                      <li class="<?php echo e(Route::currentRouteName()=='courses-list' ? 'active' : ''); ?>"><a href="<?php echo e(Route('courses-list')); ?>"><i class="fa fa-list-alt"></i> Courses </a></li>
                      <?php endif; ?>
                      <?php if($user_type == $admin): ?>
                      ...
                      <?php endif; ?>
                      <?php if($user_type == $teacher): ?>
                      <li class="<?php echo e(Route::currentRouteName()=='my-courses-list' ? 'active' : ''); ?>"><a href="<?php echo e(Route('my-courses-list')); ?>"><i class="fa fa-list-alt"></i> My Courses </a></li>
                      <?php endif; ?>
                     <?php if($user_type == $student): ?>
                      <li class="<?php echo e(Route::currentRouteName()=='student-courses-list' ? 'active' : ''); ?>"><a href="<?php echo e(Route('student-courses-list')); ?>"><i class="fa fa-list-alt"></i> Courses </a></li>
                      <li class="<?php echo e(Route::currentRouteName()=='logged-student-courses-list' ? 'active' : ''); ?>"><a href="<?php echo e(route('logged-student-courses-list')); ?>"><i class="fa fa-list-alt"></i> My Courses </a></li>
                     <?php endif; ?>
                      </ul>
                 </li>
                    <?php if($user_type == $teacher): ?>
                <li>
                    ...
                    <ul class="nav child_menu">
                        <li class="<?php echo e(Route::currentRouteName()=='course-lessons-list' ? 'active' : ''); ?>"><a href="<?php echo e(Route('course-lessons-list')); ?>"><i class="fa fa-list-alt"></i> Lessons List </a></li>
                    </ul>
                </li>
                    <?php endif; ?>
                    <?php if($user_type == $teacher): ?>
                <li>
                    ...
                    <ul class="nav child_menu">
                        <li class="<?php echo e(Route::currentRouteName()=='question-list' ? 'active' : ''); ?>"><a href="<?php echo e(Route('question-list')); ?>"><i class="fa fa-question"></i> Questions List </a></li>
                        <li class="<?php echo e(Route::currentRouteName()=='question-make' ? 'active' : ''); ?>"><a href="<?php echo e(Route('question-make')); ?>"><i class="fa fa-plus"></i> Make Question File </a></li>
                        <li class="<?php echo e(Route::currentRouteName()=='getAllQuestionFiles' ? 'active' : ''); ?>"><a href="<?php echo e(Route('getAllQuestionFiles')); ?>"><i class="fa fa-list-alt"></i> Question File List</a></li>
                    </ul>
                </li>
                    <?php endif; ?>
                    <?php if($user_type == $teacher): ?>
