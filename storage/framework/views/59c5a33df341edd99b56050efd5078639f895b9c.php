    ...
    <div class="right_col" role="main">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <?php echo Breadcrumbs::render('students'); ?>
                        ...
                        <table class="table table-striped table-bordered dataTable no-footer" id="data">
                            ...
                            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><img src="<?php echo e($student->picture); ?>" class="img-circle" alt="user image" height="40" width="40"></td>
                                    <td><?php echo e($student->name); ?></td>
                                    <td><?php echo e($student->email); ?></td>
                                    <td><?php echo e($student->country_code.$student->phone); ?></td>
                                    <td class="text-center">
                                        <button type="button"
                                                data-id="<?php echo e($student->user_id); ?>"
                                      ...
                                      <a href="<?php echo e(route('students-delete', ['id'=>$student->user_id])); ?>" class="delete" title="Delete"><button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                      <a href="<?php echo e(route('student-courses', ['id'=>$student->user_id])); ?>"><button type="button" class="btn btn-info btn-sm"><i class="fa fa-list" aria-hidden="true"></i> Show Courses</button></a>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
        ...
        <div class="modal fade" id="updateModal" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('students-update')); ?>" method="post">
        ...
        <div class="modal fade" id="addModal" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('students-add')); ?>" method="post">
                    <div class="modal-body">
                            <div class="col-md-8">
                                <input type="hidden" name="_token" value="<?php echo e(Session::token()); ?>">
                                <table class="table">
