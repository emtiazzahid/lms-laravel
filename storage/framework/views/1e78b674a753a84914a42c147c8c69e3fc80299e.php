<?php $__env->startSection('title', 'Written Question List'); ?>
    ...
    <div class="right_col" role="main">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <?php echo Breadcrumbs::render('lesson_questions',$lesson_id,$teacher_lesson->number); ?>
                ...
                <?php endif; ?>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                            <h2>Lesson - <?php echo e($teacher_lesson->title); ?> Written Question List</h2>
                                ...
                                <table class="table table-striped table-bordered dataTable no-footer" id="data2">
                                    ...
                                    <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($question->part_number); ?></td>
                                            <td><?php echo e($question->question); ?></td>
                                            <td><?php echo e($question->default_mark); ?></td>
                                            <td class="text-center">
                                                <button type="button"
                                                        data-id="<?php echo e($question->id); ?>"
                                                        data-part_number="<?php echo e($question->part_number); ?>"
                                                        data-question="<?php echo e($question->question); ?>"
                                                        data-description="<?php echo e($question->description); ?>"
                                                        data-default_mark="<?php echo e($question->default_mark); ?>"
                                                        data class="btn btn-info btn-sm" data-toggle="modal" data-target="#updateModal">
                                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                </button>

                                                <a href="<?php echo e(route('lesson-question-delete', ['id'=>$question->id])); ?>" class="delete" title="Delete"><button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
        ...
        <div class="modal fade" id="updateModal" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('lesson-question-update')); ?>" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <select name="part_number" id="" class="form-control" id="modal_port_number">
                                                <?php $__currentLoopData = $part_numbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="modal fade" id="addModal" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('lesson-question-add')); ?>" method="post">
                    <div class="modal-body">
                            <div class="col-md-8">
                                <input type="hidden" name="_token" value="<?php echo e(Session::token()); ?>">
                                <input type="hidden" name="lesson_id" value="<?php echo e($lesson_id); ?>">
