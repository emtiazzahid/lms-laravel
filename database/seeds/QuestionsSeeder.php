...
class QuestionsSeeder extends Seeder
{
    ...
    public function run()
    {
        $model = \App\Model\Question::first();
        if (empty($model)) {
            $teacherCourseLesson1 = \App\Model\TeacherCourseLesson::where('title','asymptotic notations')->first();

            $lesson1VideoPart1 = \App\Model\VideoLesson::where('lesson_id',$teacherCourseLesson1->id)->first();
            $lesson1FilePart1 = \App\Model\FileLesson::where('lesson_id',$teacherCourseLesson1->id)->first();

            $teacherCourseLesson2 = \App\Model\TeacherCourseLesson::where('title','Time complexity Analysis of iterative programs')->first();

            $lesson2VideoPart1 = \App\Model\VideoLesson::where('lesson_id',$teacherCourseLesson2->id)->first();
            $lesson2FilePart1 = \App\Model\FileLesson::where('lesson_id',$teacherCourseLesson2->id)->first();
            ...
            $lesson4VideoPart1 = \App\Model\VideoLesson::where('lesson_id',$teacherCourseLesson4->id)->first();
            $lesson4FilePart1 = \App\Model\FileLesson::where('lesson_id',$teacherCourseLesson4->id)->first();
            ...
            \App\Model\Question::insert($dataForWrittenQuestions);
            ...
            \App\Model\Mcq::insert($dataForMcqQuestions);
