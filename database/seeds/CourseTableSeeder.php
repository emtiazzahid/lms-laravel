...
class CourseTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $model = \App\Model\Course::first();
        if (empty($model)) {
            $department1 = \App\Model\Department::where('title','Department of Architecture')->first();
            $department2 = \App\Model\Department::where('title','Department of History of Art')->first();
            $department3 = \App\Model\Department::where('title','Computer Science')->first();
            $department4 = \App\Model\Department::where('title','Civil engineering')->first();
            $data = [
                [
